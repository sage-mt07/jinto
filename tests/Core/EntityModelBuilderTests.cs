...
public class EntityModelBuilderTests
{
    ...
    public void ObsoleteMethods_ThrowViaReflection()
    {
        ...
        Assert.ThrowsAny<System.Exception>(() => PrivateAccessor.InvokePrivate(builder, "HasKey", new[] { typeof(System.Linq.Expressions.Expression) }, new[] { typeof(int) }, args: new object[] { null! }));
    }
}
